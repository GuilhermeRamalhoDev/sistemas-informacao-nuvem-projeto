...
Domínio: sistema de inscrições em eventos.
- Event: um evento com capacidade limitada.
- Registration: uma inscrição de um participante num evento.
  O estado evolui de PENDING -> CONFIRMED/REJECTED através do Worker.
"""
